...
from module_admin.system.entity.vo.post_vo import PostModel
from module_admin.system.entity.vo.role_vo import RoleModel
...
class UserModel(BaseModel):
    ...
    del_flag: Optional[Literal["0", "1", "2"]] = Field(default=None, description='删除标志（0代表存在 2代表删除）')
