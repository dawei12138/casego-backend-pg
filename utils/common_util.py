...
from typing import Any, Dict, List, Literal, Union, Text
...
if __name__ == "__main__":
    print(ensure_path_sep('/utils/api_test_tool'))
...
if __name__ == '__main__':
    ...
    res = SqlalchemyUtil.base_to_dict(dict_demo, transform_case="snake_to_camel")
    print(res)
